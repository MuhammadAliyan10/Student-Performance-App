...
const UserProfile = () => {
  ...
  const data = studentData[userId ? userId : currentUser];
  console.log(data);
  const showCurrentSemester = (semesterNumber) => {
    if (semesterNumber == 1) {
      return `${semesterNumber}st`;
    } else if (semesterNumber == 2) {
      return `${semesterNumber}nd`;
    } else if (semesterNumber == 3) {
      return `${semesterNumber}rd`;
    } else {
      ...
      <div className="container">
        ...
        <div className="student__profile">
          <ul>
            ...
            <li>
              <h5>Current Progress: </h5> <p>{data?.progress["semester3"]}%</p>
            </li>
